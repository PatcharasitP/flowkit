...
export const SAMPLES = {
  th: {
    ...
    table: [
      "งาน \\ ตำแหน่ง: เจ้าหน้าที่, หัวหน้างาน, ผู้จัดการ",
      "ซื้อไม่เกิน 10,000: ทำ, อนุมัติ, -",
      "ซื้อเกิน 10,000: ทำ, ตรวจ, อนุมัติ",
      "เบิกเงินสดย่อย: ทำ, อนุมัติ, รับทราบ",
    ].join("\n"),
    mindmap: [
      "แผนงานปีหน้า",
      "  ลูกค้า",
  ...
  en: {
    ...
    table: [
      "Task \\ Role: Officer, Team lead, Manager",
      "Buy up to 10,000: do, approve, -",
      "Buy over 10,000: do, review, approve",
      "Petty cash: do, approve, informed",
    ].join("\n"),
    mindmap: [
      "Next year plan",
      "  Customers",
